...
public class NormalEnemy implements Enemy{
    public final double fullhealth = 20;
    ...
    public NormalEnemy(GameField gameField, Group root) throws Exception {
        speed = 30;
        health = fullhealth;
        gold = 25;
        armor = 2;
        ...
        InputStream input = clazz.getResourceAsStream("/image/normalenemy.png");
