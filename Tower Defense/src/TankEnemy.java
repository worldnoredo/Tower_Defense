...
public class TankEnemy implements Enemy{
    public final double fullhealth = 50;
    ...
    public TankEnemy(GameField gameField, Group root) throws Exception {
        speed = 50;
        health = 40;
        gold = 25;
        armor = 3;
        ...
        InputStream input = clazz.getResourceAsStream("/image/tankenemy.png");
